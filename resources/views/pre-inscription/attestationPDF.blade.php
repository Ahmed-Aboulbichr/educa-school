            ...
            <div class="row">
              ...
              <div class="col-lg-12">
                ...
                <div class="invoice-details mt25" >
                  ...
                  <div class="card">
                    <div class="card-body text-center">
                      <strong>Détails sur le candidat</strong>
                ...
                <div class="invoice-details mt25" >
                  ...
                  <div class="card">
                    <div class="card-body text-center"><strong>Détails sur les parents</strong>
                  ...
                  <ul class="list-unstyled col-lg-12">
                    ...
                    <ul class="list-unstyled row  " style="">
                      ...
                      <li class="col-lg-4"> Mention :
                        {{($candidat==null)?'':(($candidat->mention_bac=='P')?'Passable':(($candidat->mention_bac=='AB')?'Assez-Bien':(($candidat->mention_bac=='B')?'Bien':(($candidat->mention_bac=='TB')?'Très Bien':(($candidat->mention_bac=='E')?'Excellent':'')))))}}
                      </li>
                ...
                <div class="row"> 
                  ...
                  <ul class="list-unstyled col-lg-12">
                    ...
                    <ul class="list-unstyled row  " style="">
                      <li class=" col-lg-4"> Niveau d'étude : {{$cursus_univ->niveau_etude->intitule}}</li>
                      <li class=" col-lg-4"> Moyenne génerale :
                        {{($cursus_univ->note_S1+$cursus_univ->note_S2)/2}}</li>
                      <li class="col-lg-4"> Année universitaires : {{$cursus_univ->Annee_univ}}</li>
                    </ul>
                    <ul class="list-unstyled row  ">
                      <li class=" col-lg-6"> Université : {{$cursus_univ->universite->intitule}} </li>
                      <li class=" col-lg-6"> Spécialité : {{$cursus_univ->specialite}} </li>
                    </ul>
                  ...
                  <div class="table-responsive" style="overflow: hidden; outline: none;" tabindex="0">
                    <table class="table table-bordered">
                      ...
                      <tr>
                        ...
                        <th class="text-right">Je soussigné, certifie sur I'honneur l'exactitude de ces renseignements
                        </th>
