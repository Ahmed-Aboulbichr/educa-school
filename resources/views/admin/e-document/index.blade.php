...
@section('content')
    @component('components.breadcrumb')
        @slot('title') Liste de documents demander @endslot
        @slot('li_1') E-Document @endslot
        @slot('li_2') List des demandes @endslot
    @endcomponent
                    ...
                    <div class="table-responsive">
                        <table id="datatable-buttons" class="table mt-4">
                            <thead class="thead-light">
                                <tr>
                                    <th style="width: 25%;">Date de demande</th>
                                    <th>Document</th>
                            ...
                            <tbody>
                                <tr>
                                    <td> 19/10/2069 12:61 &emsp;<span class="badge badge-danger">New</span></td>
